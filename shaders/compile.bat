...
glslangValidator.exe --target-env spirv1.3 -DA_BITS=16 -DA_TYPE=float16_t   -DC_TYPE=float16_t -V tiled_load.comp -o tiled_loadfp16_fp16.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=16 -DA_TYPE=bfloat16_t  -DC_TYPE=float32_t -V tiled_load.comp -o tiled_loadbf16_fp32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=16 -DA_TYPE=float16_t   -DC_TYPE=float32_t -V tiled_load.comp -o tiled_loadfp16_fp32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=16 -DA_TYPE=float16_t   -DC_TYPE=float16_t -V shmem_load.comp -o shmem_loadfp16_fp16.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=16 -DA_TYPE=bfloat16_t  -DC_TYPE=float32_t -V shmem_load.comp -o shmem_loadbf16_fp32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=16 -DA_TYPE=float16_t   -DC_TYPE=float32_t -V shmem_load.comp -o shmem_loadfp16_fp32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=uint8_t     -DC_TYPE=uint32_t  -V tiled_load.comp -o tiled_loadu8_u32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=uint8_t     -DC_TYPE=uint32_t  -V shmem_load.comp -o shmem_loadu8_u32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=int8_t      -DC_TYPE=int32_t   -V tiled_load.comp -o tiled_loads8_s32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=int8_t      -DC_TYPE=int32_t   -V shmem_load.comp -o shmem_loads8_s32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=floate5m2_t -DC_TYPE=float16_t -V tiled_load.comp -o tiled_loade5m2_fp16.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=floate4m3_t -DC_TYPE=float16_t -V tiled_load.comp -o tiled_loade4m3_fp16.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=floate5m2_t -DC_TYPE=float32_t -V tiled_load.comp -o tiled_loade5m2_fp32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=floate4m3_t -DC_TYPE=float32_t -V tiled_load.comp -o tiled_loade4m3_fp32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=floate5m2_t -DC_TYPE=float16_t -V shmem_load.comp -o shmem_loade5m2_fp16.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=floate4m3_t -DC_TYPE=float16_t -V shmem_load.comp -o shmem_loade4m3_fp16.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=floate5m2_t -DC_TYPE=float32_t -V shmem_load.comp -o shmem_loade5m2_fp32.spv
glslangValidator.exe --target-env spirv1.3 -DA_BITS=8  -DA_TYPE=floate4m3_t -DC_TYPE=float32_t -V shmem_load.comp -o shmem_loade4m3_fp32.spv
